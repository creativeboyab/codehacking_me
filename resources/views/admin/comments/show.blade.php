        ...
        <table class="table table-striped">
            ...
            @foreach($comments as $comment)
                <tr>
                    ...
                    <td>{{$comment->post->title}} <br> <a href="{{route('home.post', $comment->post->id)}}" target="_blank">View Post</a> | <a href="{{route('admin.comment.replies.show', $comment->id)}}" target="_blank">View Comment</a></td>
